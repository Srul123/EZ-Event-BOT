<template>
  <div class="mx-auto w-full max-w-5xl space-y-6">
    ...
    <!-- Navigation Buttons -->
    <div
      class="flex flex-col gap-3 border-t border-neutral-200 pt-6 sm:flex-row sm:items-center sm:justify-between"
    >
      <Button
        v-if="currentStep > 0"
