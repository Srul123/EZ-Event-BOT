        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-neutral-200">
            ...
            <tbody class="bg-white divide-y divide-neutral-200">
              ...
              >
                <td
                  class="px-4 py-3 whitespace-nowrap text-sm font-medium text-neutral-900"
                >
                  {{ link.name }}
                </td>
                <td
                  class="px-4 py-3 whitespace-nowrap text-sm text-neutral-500"
                >
                  {{ link.phone }}
                </td>
